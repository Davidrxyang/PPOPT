...
from global_variables import EPISODES, PPO_BASELINE_LR, ENV
import time 
...
with open('PPO_baseline_rewards_LR:' + str(PPO_BASELINE_LR) + '.csv', mode='w', newline='') as file:
